...
public:
    ...
    /**
     * Highlights the block that the indicated camera is looking at and that is inside the indicated ChunkContainer.
     * @param camera The camera on the basis of which we are looking for the block to which it points
     * @param chunkContainer ChunkContainter, which contains the chunk with the block we are looking at
     */
